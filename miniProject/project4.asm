## -------------------------------------------------------
## program to find the maximum value of a array implemented using
## MIPS and assembly language
## This is the Project 4 as Midterm project of Computer Architecture course, ICT Program
## -------------------------------------------------------
.data
